...
import { scrollToBottom, isScrolledToBottom, distanceFromBottom, getMessageTimeKey } from "@/lib/utils";
...
export default function MessageList({
  ...
  const handleScroll = useCallback(() => {
    ...
    if (atBottom !== isAtBottom) {
      ...
      onScrollPositionChange(atBottom ? 0 : distanceFromBottom(container));
    }

    if (container.scrollTop === 0 && hasMore) {
      onLoadMore();
    }
  }, [hasMore, isAtBottom, onLoadMore, onScrollPositionChange]);
