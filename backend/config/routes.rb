Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      # Device linking: carry an existing identity into a new install (iOS
      # home-screen PWAs get an isolated storage partition)
      post 'device_links', to: 'device_links#create'
      post 'device_links/claim', to: 'device_links#claim'
